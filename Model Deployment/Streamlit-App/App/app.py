...
class App:
    ...
    def model(self):
        ...
        if selected == 'Intro':
            ...
            col2.markdown( "<h1 style='font-size: 50px;'><span style='color: white;'>Press </span> <span style='color: cyan;'>'A'</span> <span style='color: white;'>to use</span><span style='color: cyan;'> Azure Deployment</span></h1>",unsafe_allow_html=True)
            keyboard_to_url(key="A", url="https://colab.research.google.com/drive/1h70p6bJhWNBF4Iwd5zAWQ9dB7Dlzgh1d?usp=sharing")
            ...
            col1,col2,col3 = st.columns([8,10,5])
            col2.markdown( "<h1 style='font-size: 50px;'><span style='color: white;'>Press </span> <span style='color: cyan;'>'D'</span> <span style='color: white;'>to use</span><span style='color: cyan;'> Azure Deployment</span></h1>",unsafe_allow_html=True)
            keyboard_to_url(key="D", url="https://hub.docker.com/r/praveendecode/retail-sales-forecast")
